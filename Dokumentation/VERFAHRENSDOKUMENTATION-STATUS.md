...
Status:
- **GEPRÜFT** – im aktuellen R179-Code bzw. in den zugehörigen Tests nachgewiesen
...
| 14 | Scanner / Gewichtsartikel | EXTERNER NACHWEIS | HID-Scannerpfad R179 technisch gehärtet (sichtbares Fokusziel, tolerantere Timing-Logik); reale Scanner-Hardware und echte Waagenanbindung separat abzunehmen |
...
| 35 | Kassenschublade | EXTERNER NACHWEIS | R179 vereinheitlicht Aktivierung, gespeicherten DK-Ausgang und Zahlungsweg; Epson/Star-Protokolle vorhanden, reale Hardwareabnahme bleibt offen |
...
| 40 | Test, Freigabe und Nachweise | EXTERNER NACHWEIS | 1114 Safety-Checks; physische TSE-E2E-, DSFinV-K-, §6-, Pfand- und unabhängige Fiskalprüfung bleiben geschlossen |

## §16 Storno- und Retourenverfahren – präzisierter R179-Stand
...
Die technischen Produktions-Gates bleiben in R179 unverändert geschlossen.
