...
[ ] OFFENE FISKALENTSCHEIDUNG (R130): Trainingsmodus zeichnet NICHTS auf - DSFinV-K 4.2.6/Anhang B verlangen Aufzeichnung und TSE-Absicherung als AVTraining (ohne Wirkung auf den Kassenabschluss)
[ ] OFFENE FISKALENTSCHEIDUNG (R130): Kassenbewegungen (Einlage/Entnahme) sind nicht TSE-gesichert und nicht nach DSFinV-K GV_TYP unterschieden (Geldtransit, Privatentnahme, Privateinlage, Einzahlung, Auszahlung, Lohnzahlung, DifferenzSollIst)
[ ] OFFENE FISKALENTSCHEIDUNG (R130): TSE-Transaktion wird erst nach der Zahlung gestartet und sofort beendet - § 2 KassenSichV verlangt den Start "unmittelbar" mit Beginn des Vorgangs (erste Position)
[ ] DSFinV-K 3.2: vor einer Änderung von Stammdaten (Firma, USt, TSE) automatisch einen Kassenabschluss erstellen
...
[ ] DSFinV-K Datenerfassung (R131-Hinweise): Vorgangsbeginn (BON_START) und TSE-Startzeit speichern; TSE-Stammdaten (Signaturalgorithmus, Zeitformat, Public Key, Zertifikat) bei Aktivierung/Probe speichern; Stammdaten je Kassenabschluss festschreiben; Im Haus/Außer Haus je Verkauf speichern; Bestellpositionen zum Signierzeitpunkt festhalten und Bestellstorno als eigene gesicherte Gegenbuchung
[ ] Z-Bericht: Zahlarten Bar/Karte zeigen nur Verkäufe; Storno/Retouren sind nicht nach Zahlart aufgeteilt (der DSFinV-K-Kassenabschluss Z_Zahlart ist netto)
