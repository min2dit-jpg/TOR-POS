...
[ ] DSFinV-K Datenerfassung (R131-Hinweise): Vorgangsbeginn (BON_START) und TSE-Startzeit speichern; TSE-Stammdaten (Signaturalgorithmus, Zeitformat, Public Key, Zertifikat) bei Aktivierung/Probe speichern; Im Haus/Außer Haus je Verkauf speichern; Bestellpositionen zum Signierzeitpunkt festhalten und Bestellstorno als eigene gesicherte Gegenbuchung (Stammdaten je Kassenabschluss: erledigt in R132)
