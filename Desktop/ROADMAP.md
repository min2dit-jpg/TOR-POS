...
[x] R135: Training als AVTraining nach AEAO zu § 146a Nr. 1.11.1 / DSFinV-K 4.2.6 - auf einer echt buchenden Kasse werden Trainingsverkäufe in eigenen unveränderbaren Tabellen erfasst (nie in sales), als Kassenbeleg-V1 mit AVTraining TSE-signiert und im Export ohne Wirkung auf den Kassenabschluss geführt. Offen: Training im IMBISS-Bestellmodus
...
[ ] R136 offen: Vorgangsbeginn der ersten Bestellung auf dem Kassenbeleg (DSFinV-K 2.7.2); lange offene Kassenbeleg-Transaktion eines geparkten KIOSK-Bons mit Steuerberater bestätigen; viele offene Transaktionen auf echter Swissbit-TSE testen
...
[ ] DSFinV-K Datenerfassung (R131-Hinweise, Rest): Bestellpositionen zum Signierzeitpunkt festhalten und Bestelländerung/Bestellstorno als eigene gesicherte Bestellung-V1-Transaktion
