...
[ ] DSFinV-K-Export (sobald gebaut): Verkäufe mit TSE-Ausfall in TSE_Transaktionen ohne Signaturfelder aufführen, TSE_TA_FEHLER aus tse_outage_log.reason füllen (max. 200 Zeichen) - nicht weglassen und nicht nachsignieren
