...
public static class TorRelease
{
    ...
    public const string ReleaseName = "Merd-D";
    public const string Version = "0.7.33.882";
    public const string Revision = "R182";
    public const string UserAgentVersion = "0.7.33-R182";
