...
internal static class UiTranslations
{
    ...
    private static readonly Dictionary<string, string> Turkish = new(StringComparer.Ordinal)
    {
        ...
        ["Z-BERICHT läuft bereits · bitte warten."] = "Z-BERICHT zaten çalışıyor · lütfen bekleyin.",
        ["Nicht gespeichert: Bestand und Mindestbestand bitte in der neuen Einheit eintragen."] = "Kaydedilmedi: Stok ve minimum stoğu lütfen yeni birimde girin.",
        ["NEU GEZÄHLT · SPEICHERN"] = "YENİDEN SAYILDI · KAYDET",
        ["EINHEIT GEÄNDERT"] = "BİRİM DEĞİŞTİ",
        ...
        ["ZAHLUNG NICHT GESTARTET · Bondrucker nicht erkannt · noch kein Geld annehmen"] = "ÖDEME BAŞLATILMADI · fiş yazıcısı algılanmadı · henüz para almayın",
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Z-BERICHT läuft bereits · bitte warten."] = "Z-BERICHT is already running · please wait.",
        ["Nicht gespeichert: Bestand und Mindestbestand bitte in der neuen Einheit eintragen."] = "Not saved: please enter stock and minimum stock in the new unit.",
        ["NEU GEZÄHLT · SPEICHERN"] = "RECOUNTED · SAVE",
        ["EINHEIT GEÄNDERT"] = "UNIT CHANGED",
        ...
        ["ZAHLUNG NICHT GESTARTET · Bondrucker nicht erkannt · noch kein Geld annehmen"] = "PAYMENT NOT STARTED · receipt printer not detected · do not take any money yet",
