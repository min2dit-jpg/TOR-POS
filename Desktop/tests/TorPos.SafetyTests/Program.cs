...
// Restaurant DEV4 checks stay separate from main fiscal/cloud baselines.
const int RestaurantDev4Checks = 59;
...
// Restaurant foundation: 103 checks lock signed Standard/Plus entitlement,
...
if (checks != ExpectedSafetyChecks + GermanFiscalPrepChecks + CloudAlignmentChecks + RestaurantDev4Checks)
{
    throw new Exception(
        $"SAFETY BASELINE MISMATCH: expected {ExpectedSafetyChecks + GermanFiscalPrepChecks + CloudAlignmentChecks + RestaurantDev4Checks}, actual {checks}. " +
