...
[ ] OFFENE FISKALENTSCHEIDUNG (R122/F6): sale_tse_signatures ist pro Beleg endgültig - ein als TSE-Ausfall erfasster Verkauf kann NIE nachsigniert werden. Das ist eine bewusste Unveränderlichkeitsentscheidung, muss aber vor dem Produktivbetrieb gegen echte TSE-/DSFinV-K-Validierung bestätigt werden. Eine Änderung hieße: neue append-only Tabelle der Signierversuche, niemals ein UPDATE auf die bestehende
